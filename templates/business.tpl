                        ...
                        <td width="316px">
                            <div>
                              <table width="100%" border="0" cellspacing="5" cellpadding="6">
                                <tr>
                                  <td><img src="images/business_pic01.jpg"></td>
                                </tr>
                                <tr>
                                  <td><img src="images/business_pic02.jpg" width="306" height="150"></td>
                                </tr>
                              </table>
                            </div>
                        </td>
                        <td valign="top">
                            <div>
                              <table width="100%" border="0" cellspacing="10" cellpadding="8">
                                <tr>
                                  <a href="showarticle.php?articleid=206" target="_blank">
                                  <td id="us_title" style="cursor:pointer">Our Scenarios</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="showarticle.php?articleid=207" target="_blank">
                                  <td id="us_title" style="cursor:pointer">Achievements</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="showarticle.php?articleid=208" target="_blank">
                                  <td id="us_title" style="cursor:pointer">Cooperation with Companies</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="showarticle.php?articleid=209" target="_blank">
                                  <td id="us_title" style="cursor:pointer">Business Incubator</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="showarticle.php?articleid=210" target="_blank">
                                  <td id="us_title" style="cursor:pointer">National Science Park of HEU</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="showarticle.php?articleid=211" target="_blank">
                                  <td id="us_title" style="cursor:pointer">The Companies</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="research.html" target="_blank">
                                  <td id="us_title" style="cursor:pointer">Research</td>
                                  </a>
                                </tr>
                                <tr>
                                  <a href="#" target="_blank"><td id="us_title" style="cursor:pointer">International Cooperation</td>
                                  </a>
                                </tr>
                              </table>
                            </div>
