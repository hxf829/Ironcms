	...
	<table width="1000px" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td id="main_bg" valign="top">
        	<div id="main_column">
                <table width="100%" border="0" cellspacing="4" cellpadding="5" style="margin-top:4px; margin-bottom:4px;">
                  <tr>
                    <td valign="top">
                      【columnlist】
                       <table width="100%" border="0" cellspacing="5" cellpadding="5" style="margin-top:4px; margin-bottom:4px;">
                         <tr>
                            <td id="us_title" height="20px"><strong>【#columnname】</strong></td>
                         </tr>
                         <tr>
                           <td>
                             <table width="100%">
                                 <tr>
                                    <td id="ch_title">
                                      | 【articlelist(【#columnid】,5,50,0,0,1,0,0)】<a href="showarticle.php?articleid=【#id】" target="_self">【#title】</a> | 【/articlelist】
                                    </td>
                                 </tr>
                             </table>
                           </td>
